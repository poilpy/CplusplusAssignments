/*
    numvalue is the value of the numerator for the fraction object.
    denvalue is the value of the denominator for the fraction object.
    all fractions are simplified and stored in lowest terms.
*/
